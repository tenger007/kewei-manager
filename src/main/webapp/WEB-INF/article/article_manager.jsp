...
<button type="button" class="btn btn-primary" style="float:right;"onclick="window.open('${APP_PATH}/goto_article_manager/edit_article_by_id/0.do')"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br><br>
<br style="clear:both;">
        ...
        $("#send_excel").click(function(){
         ...
         function fieldChange(){
            ...
            function pageQuery( pageIndex ) {
            	...
            	$.ajax({
            		url : "${APP_PATH}/goto_article_manager/article/pageQuery.do",
            		type : "POST",
            		data : dataObj,
            		beforeSend : function() {
            				...
            				$.each(pageObj.datas, function(index, articleDto){
	            	            ...
	            	            article += '<tr>';
	          	                ...
	          	                article += '  <td style="text-align:center;">';
	          	              	article += '      <a type="button" title="编辑" onclick="window.open(\'${APP_PATH}/goto_article_manager/edit_article_by_id/'+articleDto.id+'.do\')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>';	
            ...
            function deletearticle(id) {
    			layer.confirm("删除文章，是否继续",  {icon: 3, title:'提示'}, function(cindex){
    				...
    				$.ajax({
    					url : "${APP_PATH}/goto_article_manager/delete_article_by_id.do",
    					type : "POST",
    					data : {
    						id : id
    					},
