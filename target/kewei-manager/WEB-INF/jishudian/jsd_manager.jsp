        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-th"></i> 技术点数据列表</h3>
			  </div>
...
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.open('/kewei-manager/goto_jsd_manager/edit_jsd_by_id/0.do')"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br><br>
<br style="clear:both;">
	...
	<script src="js/bootstrap/js/select2.js"></script>
        <script type="text/javascript">
            ...
            function pageQuery( pageIndex) {
            	...
            	$.ajax({
            		url : "/kewei-manager/goto_jsd_manager/jsd/pageQuery.do",
            		type : "POST",
            		data : dataObj,
            		beforeSend : function() {
            				...
            				$.each(pageObj.datas, function(index, jsdDto){
	            	            ...
	            	            jsd += '<tr>';
	          	                ...
	          	                jsd += '  <td style="text-align:center;">';
	          	              	jsd += '      <a type="button" title="编辑" onclick="window.open(\'/kewei-manager/goto_jsd_manager/edit_jsd_by_id/'+jsdDto.id+'.do\')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>';	
            ...
            function deletejsd(id) {
    			layer.confirm("删除技术点，是否继续",  {icon: 3, title:'提示'}, function(cindex){
    				...
    				$.ajax({
    					url : "/kewei-manager/goto_jsd_manager/delete_jsd_by_id.do",
    					type : "POST",
    					data : {
    						id : id
    					},
            ...
            function deletejsds() {
    			...
    			layer.confirm("删除选择的技术点，是否继续",  {icon: 3, title:'提示'}, function(cindex){
    				...
    				$.ajax({
    					url : "/kewei-manager/goto_jsd_manager/delete_jsds_by_ids.do",
    					type : "POST",
    					data : dataObj,
    					success : function( r ) {
    						if ( r.success ) {
