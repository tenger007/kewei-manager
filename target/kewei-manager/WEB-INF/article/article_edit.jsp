...
<%@include file="/WEB-INF/common/userinfo.jsp"%>
				...
				<form  enctype="multipart/form-data" class="form-inline" role="form" style="float:left;" id="articleForm">
				  ...
				  &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
				   <div class="form-group">
					...
					<input type="radio" class="form-control" value="1" name="isforecast" id="isforecast0" ${articleDto.isforecast=="1" ? "checked='checked'" : ""} />相关
					<input type="radio" class="form-control" value="0" name="isforecast" id="isforecast1" ${articleDto.isforecast=="0" ? "checked='checked'" : ""} />预测
				  </div>
				  <br><hr>
				   <div class="form-group">
    ...
    <form id="uploadForm" action="/kewei-manager/goto_article_manager/import_article/${articleDto.id}.do" method="post" enctype="multipart/form-data">
        <input type="hidden" id="id" name="id" value="${articleDto.id}">
	...
	<script src="/kewei-manager/js/bootstrap/js/select2.js"></script>
	    ...
	    $("#updateBtn").click(function(){
	    	...
	    	$.ajax({
	            type: "post",
	            url: "/kewei-manager/goto_article_manager/update_article.do",
